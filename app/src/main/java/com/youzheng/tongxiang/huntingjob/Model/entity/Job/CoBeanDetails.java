...
public class CoBeanDetails implements Serializable{
    ...
    public void setContactOpen(String contactOpen) {
    ...
    public void setMobileOpen(int mobileOpen) {
    ...
    public String getPro_city_dist() {
        return pro_city_dist;
    }

    public void setPro_city_dist(String pro_city_dist) {
        this.pro_city_dist = pro_city_dist;
    }
